...
{
	class Gipsy6XS : Gipsy6
	{

		#region DEFCONF

		public static readonly byte[] defConf = new byte[502] {
		// 0	CF = Modulo spento, CE = Modulo acceso;		1  Current Memory Type
		0xCF, 0x00, 0x00, 0x02,
		// 4	Nome unità: 27 caratteri + terminatore 0
		0x4e, 0x6f, 0x20, 0x4e, 0x61, 0x6d, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		...
		0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		//276 - G1: Schedule E (15 minuto)
		0x0f, 0x01,
		//278 - G1: Schedule F (20 secondi)
		0x14, 0x00,
		// 280	G1: Orari
		...
		0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		//464 - G2: Schedule G (1 ora)
		0x01, 0x02,
		//466 - G2: Schedule H (5 minuti)
		0x05, 0x01,
		// 468	G2: Orari
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		// 492	G1/G2 Enable + 2 byte padding
		0x00, 0x00, 0x00, 0x00,
		//496	Soglie batteria
		0x11, 0x09,		//3.40V		batteryStartLogging
		0xCD, 0x08, 	//3.30V		batteryPauseLogging
		0xAB, 0x0A		//4.00V		batteryRestartLogging
		//502
		};
		...
		public override byte[] getConf()
		{
			...
			try
			{
				for (int i = 0; i < 7; i++)
				{
					for (int j = 0; j < 64; j++)
					{
						conf[32 + i * 64 + j] = ft.ReadByte();
					}
					ft.Write(new byte[] { 1 }, 1);//***********************************************SYNC
				}
				for (int j = 480; j < 502; j++)
				{
					conf[j] = ft.ReadByte();
				}
				ft.Write(new byte[] { 1 }, 1);//***********************************************SYNC
